          ...
          <div className="relative z-10 flex items-center flex-wrap gap-35">
            <div className="flex flex-col gap-14">
              <div className="flex flex-col gap-5">
                <h1 className="font-bold font-roboto text-6xl bg-[linear-gradient(to_right,#F6F6F3,#CB96AB,#BE709A)] bg-clip-text text-transparent tracking-wide pb-5">
                  Hand Betting Game
                </h1>
              </div>

              <p className="w-full text-left font-mono text-md text-[#CB96AB] text-center">
                <div className="p-3 bg-[#17141A]/50 border rounded-full border-[#BE709A]/30 shadow-md">
                  <Typewriter
                    options={{
                      strings: [
              ...
              <div className="flex flex-row gap-5 justify-start -tems-center">
                <button className="flex bg-[#CB96AB] p-3 pr-7 pl-7 rounded-full flex-2 font-roboto shadow-md shadow-black/50 hover:bg-[#BE709A] transition duration-300 ease-in-out cursor-pointer hover:text-white hover:scale-110  items-center justify-center">
                  Try Now
                </button>
                <button
                  onClick={() => {
